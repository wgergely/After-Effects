...
:: -c:v [option] -- prores_ks or prores
...
set VIDEO=-c:v prores -profile:v 3 -qscale:v 10 -vendor ap10 -pix_fmt yuv422p10le
set AUDIO=-c:a pcm_s16le -filter_complex asetnsamples=n=16384:p=0
...
"C:\Program Files (x86)\QuickTime\QuickTimePlayer.exe" "%output%"
