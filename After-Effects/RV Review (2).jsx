    ...
    var FrameWindow = ( function ( thisObj, inTitle, inNumColumns, columnTitles, columnWidths ) {
        ...
        //Event Functions
        {
            ...
            function refreshButton_onClick() {
                ...
                internal.clear();
                internal.setlist( collect.item( itemIndex ).exists.names, collect.item( itemIndex ).exists.dates, collect.item( itemIndex ).exists.sizes );
                settings.setbasepath();
...
//            }
        ...
        //Event Functions
        {
            ...
            function aerenderButton_onClick() {
                internal.aerender( false );
            }    
            function batchButton_onClick(){
                internal.aerender( true );
            }    
            ...
            function versionsDropdown_onChange(){
                ...
                if ( versionsDropdown.selection.text === 'Set Version Control' ) {
                    ...
                    if (!pathcontrol.getVersion() ) {
                        ...
                        internal.setdropdown( pathcontrol.getVersions() )
                        pathcontrol.apply();
                    }
                } else {
        ...
        //UI
        {
            ...
            // List
            {
                ...
                listItem.size = [0,0];
                listItem.onChange = listItem.onChanging = function(){
                    if (listItem.selection){
                        ...
                        if ( pathcontrol.getVersion() ) {
                            ...
                            if ( pathcontrol.getVersions().length > 0 ) {
                                ...
                                internal.setdropdown(  [noVersions] );
                            }
                            
                        } else {
                            var setVersionControl = new Folder('Set Version Control');
                            internal.setdropdown( [setVersionControl] )
        ...
        //Internal Methods
        var internal = {}
        internal.setdropdown = function ( inArr ){
            if (inArr.length > 0) {
                var item;                
                for (var i = 0; i < inArr.length; i++) {
        ...
        internal.cleardropdown = function (){
             versionsDropdown.removeAll();
        }
        internal.aerender = function ( promptForFile ) {
        ...
        internal.setSelection = function( index ) {
        ...
        internal.getSelection = function( index ) {
            if (palette instanceof Window){
                listItem = palette.findElement('listItem');
            }
            var s;
        ...
        var cls = function() {
            this.setSelection = function ( index ) {
                return internal.setSelection( index );
            };
            this.getSelection = function () {
                return internal.getSelection();
            };
    ...
    //Adout this script
    {
        this.lastmodified = '15/12/2015';
        this.version = '0.1.4';
        this.name = settings.scriptname;
