function init_partition(PPG_properties)
{
	...
	*/
	var makelocal = PPG_properties.override;
	...
	var matte = PPG_properties.matte;
	var Arnold_Matte = {
...
function init(){
	...
	function create_OnClicked()
	{
		...
		{
			var PPG_properties = {
				"override" : PPG.override,
				"presets" : PPG.presets,
				"ray" : PPG.ray,
				"vis_camera" : PPG.vis_camera,
				"vis_shadows" : PPG.vis_shadows,
				"vis_reflected" : PPG.vis_reflected,
				"vis_refracted" : PPG.vis_refracted,
				"vis_diffuse" : PPG.vis_diffuse,
				"vis_glossy" : PPG.vis_glossy,
				"matte" : PPG.matte,
				"matte_camera" : PPG.matte_camera,
				"matte_camera_colorR" : PPG.matte_camera_colorR,
				"matte_camera_colorG" : PPG.matte_camera_colorG,
				"matte_camera_colorB" : PPG.matte_camera_colorB,
				"matte_camera_colorA" : PPG.matte_camera_colorA,
				"matte_use_alpha" : PPG.matte_use_alpha,
				"matte_use_opacity" : PPG.matte_use_opacity,
				"matte_opacity" : PPG.matte_opacity
			}
